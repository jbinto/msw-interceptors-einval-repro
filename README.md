# EINVAL Reproduction & Fix

This repository reproduces the `EINVAL` socket crash in `@mswjs/interceptors` when used with `dd-trace` under high concurrency. It also demonstrates a verified fix.
